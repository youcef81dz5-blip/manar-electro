...
const SYSTEM_PROMPT = `أنت "مساعد منار إلكترو" — مساعد تقني افتراضي يعمل لصالح محل إلكترونيات وخدمات تقنية اسمه Manar Electro في الجزائر.
تخصصات المحل:
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Lovable AI already returns OpenAI-compatible SSE — pass it through.
